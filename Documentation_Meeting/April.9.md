# Weekly Meeting on April.4 

## EOSC-511 Group Presentation Updates

Link: https://docs.google.com/presentation/d/1O2QeWb16mLAYcMgHcppOZ1DTZqPw0emr2Xc63fsa650/edit?usp=sharing

### Results

In results part 2, we will mainly focus on the physical interpretation of sensitivity experiments, and leave error analysis, comparison of different schemes and analytical solution to part 1.

### Discussion&Conclusion

One of the main conclusions for part 2 is that advection is the dominating factor of advection-diffusion process, as the diffusion coefficient in physical world is relatively stable while the velocity of currents vary a lot in time and space.

### Feedback

The diffusivity coefficient varies a lot actually. The question here is that if we want to keep the conclusion of 'advection is dominating the transportation', and how we can change the parameters (especially diffusivity coefficient $D$) to prove it, and how we can rationalize that change of parameter.


## EOSC-573 Presentation

Intruding water tracing indicates that intermediate water (from Folger Deep) is the source, while kinetic (ADCP) analysis indicate that subsurface water (Folger Pinnacle) is also intruding.

I intend to argue that they are **BOTH** intruding Barkley Sound, especially Trevor Channel.


## Report on Diatom/Flagellate

Link to Suchy's paper: https://agupubs.onlinelibrary.wiley.com/doi/full/10.1029/2024JC021036
...
How should we structure our report?

### Feedback

In so far, we can keep PCA, which is a method used by Moore. Delete all the unreliable contents.