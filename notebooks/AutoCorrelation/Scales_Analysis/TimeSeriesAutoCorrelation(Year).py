...
indir='/results/forcing/atmospheric/continental2.5/nemo_forcing/'
indir_results='/home/jqiu/Programing/AutoCorrelation/Scales_Analysis/' # 使用新的结果目录
# 确保结果目录存在
os.makedirs(indir_results, exist_ok=True)

fnames=['hrdps_y2024m01d01.nc','hrdps_y2024m02d01.nc','hrdps_y2024m03d01.nc','hrdps_y2024m04d01.nc',
'hrdps_y2024m05d01.nc', 'hrdps_y2024m06d01.nc','hrdps_y2024m07d01.nc', 'hrdps_y2024m08d01.nc',
'hrdps_y2024m09d01.nc','hrdps_y2024m10d01.nc','hrdps_y2024m11d01.nc','hrdps_y2024m12d01.nc']
...
if len(x_scales) > 0 and len(y_scales) > 0:
    ...
    plt.title('Distribution of Horizontal (X) Correlation Scales (R=0.5) in Year Round')
    ...
    plt.title('Distribution of Vertical (Y) Correlation Scales (R=0.5) in Year Round')
    plt.xlabel('Lag Distance (Index Units)')
    plt.ylabel('Frequency')
    plt.legend()
    plt.grid(axis='y', alpha=0.5)
    ...
    plt.tight_layout()
    plot_filename = os.path.join(indir_results, 'R_05_Correlation_Scales_Distribution_Year_Round.png')
